...
class Server
{
	...
	public:
		...
		void			disconnectRequest (int requestFd);
		void			checkConnection (int requestFd);
		int				initListen (const std::string& hostPort);
		...
		void			locationToServer (LocationBlock locationBlock);
